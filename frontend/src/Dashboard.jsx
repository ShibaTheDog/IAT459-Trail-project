  ...
  return (
    <div className="dashboard-container">
        ...
        {!user ? (
          ...
          <>
            ...
            <div className="empty-state">
              ...
              <button className="login-button" onClick={() => navigate("/create-post")}>
                Create post
              </button>
            </div>
          </>
      ...
      <div className="statistics-section">
        ...
        {!user ? (
          <div className="empty-state">
            <p><strong>You must login to view your statistics</strong></p>
          </div>
        ) : (
      ...
      <div className="map-section">
        ...
        >
          {showEasy ? "Disable Easy" : "Enable Easy"}
        </button>
        ...
        >
          {showIntermediate ? "Disable Intermediate" : "Enable Intermediate"}
        </button>
        ...
        >
          {showDifficult ? "Disable Difficult" : "Enable Difficult"}
        </button>
          ...
          >
            {dataSet
              .filter((trail) => {
                ...
                if (trail.difficulty === "Intermediate" && !showIntermediate) return false;
                if (trail.difficulty === "Difficult" && !showDifficult) return false;
                return true;
              })
              .map((trail) => (
                <Marker
